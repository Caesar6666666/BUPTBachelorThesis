...
\section{扩散模型概述}
\section{文本生成技术进展}
\section{bash命令生成的研究现状}
\section{DiffusSeq模型的结构与特点}
\section{Classifier-Free Guidance方法}
\section{本章小结}

\chapter{bash命令生成算法设计}
\section{bash命令的预处理与编码}
\section{模型训练策略}
\section{模型优化与调参方法}
\section{Classifier-Free Guidance的集成与调整}
